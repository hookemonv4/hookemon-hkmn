...
// Fixed USD risk rails remain independent of the owner's external-capital ceiling and of
// transferable native ETH or Solana USDC. Admission requires independent, authenticated USD
// valuations for the unit and aggregate funding quotes; no asset parity is implied.
const MAX_UNIT_PRICE_MICRO_USD = 55_000_000n;
...
export const OPERATOR_HARD_CAPS = Object.freeze({
  ...
  maxUnitPriceMicroUsd: MAX_UNIT_PRICE_MICRO_USD.toString(),
  maxCycleBudgetMicroUsd: (MAX_UNIT_PRICE_MICRO_USD * CYCLE_BUDGET_MULTIPLE).toString(),
  max24HourBudgetMicroUsd: (MAX_UNIT_PRICE_MICRO_USD * CYCLE_BUDGET_MULTIPLE * DAILY_BUDGET_MULTIPLE).toString(),
  maxHeldPositions: '10',
