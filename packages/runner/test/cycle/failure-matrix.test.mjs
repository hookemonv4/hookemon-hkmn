...
const EXPECTED_OUTCOMES = new Map([
  ...
  ['Native principal canary:wrong-principal-identity', outcome('HELD_UNAVAILABLE', 'owner-decision', 'WP14')],
  ['Native principal canary:insufficient-principal-and-gas', outcome('HELD_UNAVAILABLE', 'owner-decision', 'WP14')],
