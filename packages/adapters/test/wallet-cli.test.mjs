...
// contention any one of the three can legitimately be the stage that exceeds it first; this
// asserts the failure is exactly one of those three known 50ms outcomes, not a specific one.
