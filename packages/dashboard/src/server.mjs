 ...
 * @param {object|null} [ctx.catalog] @param {object} [ctx.readiness] - static bootstrap values used
 *   when the dynamic readers below are absent.
 * @param {() => Promise<object>} [ctx.readCatalog] - dynamic bootstrap catalog reader.
 * @param {(input: {authorityStatus: object|null, catalog: object|null}) => Promise<object>} [ctx.readReadiness]
 *   - dynamic bootstrap readiness reader.
