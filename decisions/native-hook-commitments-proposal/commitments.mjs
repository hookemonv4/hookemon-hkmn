// PROPOSAL ONLY. Pure hashing/validation; does not authenticate evidence or authorize launch.
...
export function deriveProposal({ binding, runtime, sourceBytes, evidenceBytes }) {
