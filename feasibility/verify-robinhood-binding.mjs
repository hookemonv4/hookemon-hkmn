...
function validatePhase3OffchainAmendment(freeze, frozen, projectRoot) {
  ...
  invariant(amendment.interfaceRequirementsRevision === 67 && amendment.interfaceArchitectureRevision === 10
    && [68, 69, 70].includes(amendment.approvedRequirementsRevision), "unsupported offchain amendment revisions");
  ...
  if (amendment.approvedRequirementsRevision === 70) approvalPaths.push("decisions/owner-approvals/revision-70-collector-explicit-spec-s5-approved.json");
  ...
  for (const approvalPath of approvalPaths) {
    ...
    if (amendment.approvedRequirementsRevision === 70 && approvalPath.includes("revision-69-")) invariant(approval.subjectHashes["specs/requirements.json"] === "4c05221e177aa820d7e282f1d343a32fafc5a1aac5458f516612f5cb7625a67f", "offchain revision-69 approval subject mismatch");
