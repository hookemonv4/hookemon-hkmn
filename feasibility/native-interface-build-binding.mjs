...
const implementationScopeRequirementsSha256 = 'b0f2f2a0a6dcce44a08940d70be107988800c58b950ae1dcc660d32de62329c3';
...
const pinnedSnapshotHashes = Object.freeze({
  ...
  "architecture/interfaces.json": "5f4a03c0c5f5a47e6b1076a97b89d1c6a24ceff01fe158fb7cc50117e52cf332",
...
export const nativeBuildInputs = Object.freeze([
  'decisions/owner-approvals/revision-73-collector-core-approved.json',
...
export function validateNativeInterfaceBuildBinding({ projectRoot, frozen, freeze, manifest }) {
  ...
  assert(record.requirementsRevision === 73 && record.architectureRevision === 11, 'revision mismatch');
  ...
  assert(frozen.productPhase === 3 && frozen.requirementsRevision === 73 && frozen.architectureRevision === 11,
  ...
  assert(frozen.nativeMigration.requirementsRevision === 73
