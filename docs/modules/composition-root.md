...
Live composition supplies `readCycleConfiguration` from the persisted operator authority to freeze pack and recipient settings together. The native eligibility stage receives the immutable cycle policy; direct and supplementary payout reconstruction preserve selection-bearing v3 plans while retaining legacy v2 plans.
