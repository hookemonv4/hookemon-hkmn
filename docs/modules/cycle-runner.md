...
Chain and supplementary reconciliation preserve the immutable native payment binding authenticated in the current process. Canonical copies retain data only; serialized lookalikes do not acquire release authority. The retained binding must match the canonical configuration digest.
