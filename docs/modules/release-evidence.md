...
- `PhaseThreeReleasePlan.Draft` pins chain 4663, the graph roles, target template hashes, a 1,000,000,000-HKMN supply, a full canonical-market allocation, zero other allocation, legacy 240-USDG seed and full-range fixture defaults, the revised inclusive 20/40/240 basis-point fee split, and one exact price-order tuple.
