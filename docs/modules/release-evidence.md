...
The native draft and materialized address schemas require optimizer 200 and viaIR. Historical v1 manifests retain optimizer 1000 without viaIR; a native manifest cannot reuse that compiler profile.
