...
- `PhaseThreeReleasePlan.Draft` pins chain 4663, the graph roles, target template hashes, a 1,000,000,000-HKMN supply, a full canonical-market allocation, zero other allocation, a 240-USDG seed, full-range ticks, the historical 10/40/250 basis-point fee split, and one exact price-order tuple.
