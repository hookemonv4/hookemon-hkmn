...
const journeySteps = [
  ...
  },
  {
    ...
    number: "02",
    title: "Split the 3%",
    copy: "Buys and sells include one 3% fee: 0.2% for Programmable, 0.4% for the fixed Treasury wallet, and 2.4% for the pack engine.",
        ...
        <div className="economics-grid inventory-menu">
          <article className="fee-panel" data-reveal="left">
            ...
            <div className="fee-flow">
              ...
              <section
                className="fee-composition"
                aria-label="3 percent Hook fee: 0.2 percent Programmable, 0.4 percent Treasury, and 2.4 percent pack engine"
              >
                <div className="fee-composition-heading">
