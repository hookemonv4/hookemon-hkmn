...
const GERMAN_STATUS_LABELS: Readonly<Record<string, string>> = Object.freeze({
  ...
  "bridging-to-evm": "Rücktransfer zur EVM-Kette läuft",
  ...
  ready: "Bereit",
  "catalog-not-loaded": "Packkatalog nicht geladen",
  "authority-unavailable": "Betriebssteuerung nicht verfügbar",
  "configuration-missing": "Konfiguration fehlt",
  "pack-plan-not-in-catalog": "Packplan ist nicht im Katalog",
  "execution-profile-inspection": "Inspektionsprofil ist aktiv",
