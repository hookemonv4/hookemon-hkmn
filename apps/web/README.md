...
Public Hookemon website and dashboard in the canonical [repository](https://github.com/hookemonv4/hookemon-hkmn). Holding, reward accounting, and automatic payment do not depend on a website login.
