...
import { projectCycleAccounting } from '../../../packages/adapters/src/app/accounting-projection.mjs';
import { buildPublicCycleStatus } from '../../../packages/dashboard/src/projections/cycle-status-projection.mjs';
import { buildPublicCommunitySnapshot } from '../../../packages/dashboard/src/projections/community-snapshot-projection.mjs';
...
import { validateDashboardPair, latestPayout, processStep } from '../public/comic-production/dashboard.mjs';
