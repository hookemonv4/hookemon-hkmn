/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config dist/server/wrangler.json worker-configuration.d.ts` (hash: 4fcf431d914148fcce25f0800c60fb89)
// Runtime types generated with workerd@1.20260515.1 2026-08-07 nodejs_compat
interface __BaseEnv_Env {
	OPERATOR_CONTROL_SERVICE_URL: string;
	OPERATOR_CONTROL_PROXY_CREDENTIAL: string;
